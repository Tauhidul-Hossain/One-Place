      ...
      <div>
        ...
        <div className="clientInfo">
          <div className="clientContactInfo">
            ...
            <div className="clientInfoGroup">
              <div className="clientInfoLabel">Mobile number</div>
              <div className="clientInfoText">
                {clientData.client ? clientData.client.mobile : ""}
              </div>
            </div>
            <div className="clientInfoGroup">
          ...
          <div className="clientContactInfo">
            ...
            <div className="clientInfoGroup">
              <div className="clientInfoLabel">Company Name</div>
              <div className="clientInfoText">
                {clientData.client ? clientData.client.companyName: ""}
              </div>
            </div>
            <div className="clientInfoGroup">
